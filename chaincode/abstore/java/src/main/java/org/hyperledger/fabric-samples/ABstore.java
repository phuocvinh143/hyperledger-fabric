...
public class ABstore extends ChaincodeBase {
    ...
    public Response invoke(ChaincodeStub stub) {
	    ...
	    if (func.equals("invoke_random")) {
                return invoke_random(stub, params);
            }
            ...
            return newErrorResponse("Invalid invoke function name. Expecting one of: [\"invoke_random\", \"invoke\", \"delete\", \"query\"]");
        } catch (Throwable e) {
            return newErrorResponse(e);
        }
    }
    ...
    private Response invoke(ChaincodeStub stub, List<String> args) {
        ...
        //Random rand = new Random();
      	//int rand_int1 = rand.nextInt(0); 
        //int rand_int2 = rand.nextInt(0); 
    ...
    private Response invoke_random(ChaincodeStub stub, List<String> args) {
        if (args.size() != 3) {
            return newErrorResponse("Incorrect number of arguments. Expecting 3");
        }
        String accountFromKey = args.get(0);
        ...
        accountFromValue -= amount + rand_int1;
        accountToValue += amount + rand_int1;
        ...
        return newSuccessResponse("invoke_random finished successfully", ByteString.copyFrom(accountFromKey + ": " + accountFromValue + " " + accountToKey + ": " + accountToValue, UTF_8).toByteArray());
    }
